...
c=0.83
X_trainv, X_testv = functions.Vectorizer_Cv(X_train,X_test,c)
...
lr = LogisticRegression(C=6.5, penalty='l2', solver='sag',max_iter=700) #prima era 800
lr.fit(X_tr_s, y_train)
lr_score = lr.score(X_test_s, y_test)
print("Results for Logistic Regression with CountVectorizer and max_df=",c)
print(lr_score)
